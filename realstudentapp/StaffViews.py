...
from realstudentapp.models import Attendance, AttendanceReport, Courses, CustomUser, \
     FeedBackStaffs, LeaveReportStaff, NotificationStaffs, OnlineClassRoom, SessionYearModel, \
