...
from realstudentapp.models import Courses, SessionYearModel
...
class AddStudentForm(forms.Form):
    ...
    username = forms.CharField(label = "Usernam", max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
