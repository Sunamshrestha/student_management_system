...
from realstudentapp.models import Courses
...
class AddStudentForm(forms.Form):
    ...
    username = forms.CharField(label = "Usernam", max_length=50)
    ...
    session_start = forms.DateField(label = "Session Star",widget = DateInput())
