...
from realstudentapp import views, HodViews, StaffViews, StudentViews
from realstudentapp.EditResultViewClass import EditResultViewClass
from studentapp import settings
